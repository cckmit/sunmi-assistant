      ...
      post{
        success {
          ...
          script{
            ...
            emailext(attachLog: false, body: '''Download url:	 http://d.alphaqr.com/lcxt<br/>更新内容：<br/>''' + changeString, mimeType: 'text/html', subject: 'Android Test Build Ready', to: recipient_list)
          }
        } 
      }
    }
...
def NotifyBuild(String buildStatus = 'STARTED', String stage){
  ...
  def recipient_list = 'lukai@sunmi.com,xiaoxinwu@sunmi.com,yangshijie@sunmi.com,yangjibin@sunmi.com,linyuanpeng@sunmi.com,ningrulin@sunmi.com,lixuanzhen@sunmi.com,yangzhen@sunmi.com,yinhui@sunmi.com'
