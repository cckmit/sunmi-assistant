...
/**
 * Description:
 * Created by bruce on 2019/4/2.
 */
public class AACAudioTrack {
    private int mFrequency;// 采样率
    private int mChannel;// 声道
    private int mSampBit;// 采样精度
    private AudioTrack mAudioTrack;

    public AACAudioTrack(int frequency, int channel, int sampbit) {
    ...
    public void playAudioTrack(byte[] data, int offset, int length) {
        ...
        try {
            ...
            Log.e("AACAudioTrack", "AudioTrack Exception : " + e.toString());
        }
    }
