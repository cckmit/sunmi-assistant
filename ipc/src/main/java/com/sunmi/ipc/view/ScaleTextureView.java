...
/**
 * Description: ScaleTextureView
 * Created by Bruce on 2020/2/20.
 */
public class ScaleTextureView extends TextureView implements View.OnTouchListener {
    ...
    public ScaleTextureView(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public ScaleTextureView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
