 ...
 * @date 2019-09-09
 */
public class SunmiIMediaPlayer extends FrameLayout {
    /**
    ...
    public SunmiIMediaPlayer(@NonNull Context context) {
        this(context, null);
    }

    public SunmiIMediaPlayer(@NonNull Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public SunmiIMediaPlayer(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
