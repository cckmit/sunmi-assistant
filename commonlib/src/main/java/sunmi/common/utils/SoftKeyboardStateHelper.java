...
public class SoftKeyboardStateHelper implements ViewTreeObserver.OnGlobalLayoutListener {
    ...
    private final int HEIGHT_PIXELS = 100;
    ...
    public void onGlobalLayout() {
        ...
        if (!isSoftKeyboardOpened && heightDiff > HEIGHT_PIXELS) { // if more than 100 pixels, its probably a keyboard...
            isSoftKeyboardOpened = true;
            notifyOnSoftKeyboardOpened(heightDiff);
        } else if (isSoftKeyboardOpened && heightDiff < HEIGHT_PIXELS) {
