 ...
 */
package com.sunmi.assistant.dashboard.ui.refresh;
...
public class RefreshLayout extends FrameLayout {
    ...
    public void setRefreshViewHolder(BaseRefreshViewHolder refreshViewHolder, int marginTop) {
        mRefreshViewHolder = refreshViewHolder;
        mRefreshViewHolder.setRefreshLayout(this);
        initRefreshHeaderView(marginTop);
    ...
    public void startChangeWholeHeaderViewPaddingTop(int distance) {
        ...
        animator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            ...
            public void onAnimationUpdate(ValueAnimator animation) {
                ...
                ((MarginLayoutParams) mRecyclerView.getLayoutParams()).topMargin = paddingTop - mMinWholeHeaderViewPaddingTop;
            }
        });
        animator.start();
    }
    ...
    private boolean isContentViewToTop() {
        ...
        return BGARefreshScrollingUtil.isRecyclerViewToTop(mRecyclerView);
    }
    ...
    public int getMaxWholeHeaderViewPaddingTop() {
        return mMaxWholeHeaderViewPaddingTop;
    }
