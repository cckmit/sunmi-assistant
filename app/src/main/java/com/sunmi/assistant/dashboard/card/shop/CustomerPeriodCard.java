...
public class CustomerPeriodCard extends BaseRefreshCard<CustomerPeriodCard.Model, Object> {
    ...
    private CustomerPeriodCard(Presenter presenter, DashboardCondition condition, int period, Interval periodTime) {
        super(presenter, condition, period, periodTime);
    }

    public static CustomerPeriodCard get(Presenter presenter, DashboardCondition condition, int period, Interval periodTime) {
        if (sInstance == null) {
            sInstance = new CustomerPeriodCard(presenter, condition, period, periodTime);
        } else {
