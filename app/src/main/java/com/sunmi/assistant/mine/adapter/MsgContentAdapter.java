 ...
 */
public class MsgContentAdapter extends BaseQuickAdapter<ChildrenBean, BaseViewHolder> {

    private String TAG = "MsgContentAdapter";
    ...
    public MsgContentAdapter(List<ChildrenBean> data, Context context) {
    ...
    protected void convert(BaseViewHolder helper, ChildrenBean item) {
        ...
        helper.getView(R.id.rl_msg_content).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (listener != null) {
                    listener.onClick(item.getModelId(), title);
                }
            }
        });
    }
