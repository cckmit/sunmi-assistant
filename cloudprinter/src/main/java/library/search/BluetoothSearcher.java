...
import library.search.classic.BluetoothClassicSearcher;
import library.search.le.BluetoothLESearcher;
import library.search.response.BluetoothSearchResponse;

import static library.Constants.SEARCH_TYPE_BLE;
import static library.Constants.SEARCH_TYPE_CLASSIC;
