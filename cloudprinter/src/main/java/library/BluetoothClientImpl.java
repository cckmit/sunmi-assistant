...
import library.connect.response.BleMtuResponse;
import library.connect.response.BleNotifyResponse;
import library.connect.response.BleReadResponse;
import library.connect.response.BleReadRssiResponse;
import library.connect.response.BleUnnotifyResponse;
import library.connect.response.BleWriteResponse;
import library.connect.response.BluetoothResponse;
import library.model.BleGattProfile;
import library.receiver.BluetoothReceiver;
import library.receiver.listener.BleCharacterChangeListener;
import library.receiver.listener.BleConnectStatusChangeListener;
import library.receiver.listener.BluetoothBondListener;
import library.receiver.listener.BluetoothBondStateChangeListener;
import library.receiver.listener.BluetoothStateChangeListener;
import library.search.SearchRequest;
import library.search.SearchResult;
import library.search.response.SearchResponse;
import library.utils.BluetoothLog;
import library.utils.ListUtils;
import library.utils.proxy.ProxyBulk;
import library.utils.proxy.ProxyInterceptor;
import library.utils.proxy.ProxyUtils;

import static library.Constants.CODE_CLEAR_REQUEST;
import static library.Constants.CODE_CONNECT;
import static library.Constants.CODE_DISCONNECT;
import static library.Constants.CODE_INDICATE;
import static library.Constants.CODE_NOTIFY;
import static library.Constants.CODE_READ;
import static library.Constants.CODE_READ_DESCRIPTOR;
import static library.Constants.CODE_READ_RSSI;
import static library.Constants.CODE_REFRESH_CACHE;
import static library.Constants.CODE_REQUEST_MTU;
import static library.Constants.CODE_SEARCH;
import static library.Constants.CODE_STOP_SESARCH;
import static library.Constants.CODE_UNNOTIFY;
import static library.Constants.CODE_WRITE;
import static library.Constants.CODE_WRITE_DESCRIPTOR;
import static library.Constants.CODE_WRITE_NORSP;
import static library.Constants.DEVICE_FOUND;
import static library.Constants.EXTRA_BYTE_VALUE;
import static library.Constants.EXTRA_CHARACTER_UUID;
import static library.Constants.EXTRA_DESCRIPTOR_UUID;
import static library.Constants.EXTRA_GATT_PROFILE;
import static library.Constants.EXTRA_MAC;
import static library.Constants.EXTRA_MTU;
import static library.Constants.EXTRA_OPTIONS;
import static library.Constants.EXTRA_REQUEST;
import static library.Constants.EXTRA_RSSI;
import static library.Constants.EXTRA_SEARCH_RESULT;
import static library.Constants.EXTRA_SERVICE_UUID;
import static library.Constants.EXTRA_TYPE;
import static library.Constants.GATT_DEF_BLE_MTU_SIZE;
import static library.Constants.REQUEST_SUCCESS;
import static library.Constants.SEARCH_CANCEL;
import static library.Constants.SEARCH_START;
import static library.Constants.SEARCH_STOP;
import static library.Constants.SERVICE_UNREADY;
