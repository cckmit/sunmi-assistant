...
public class BGABadgeViewHelper {
    ...
    private void initCustomAttrs(Context context, AttributeSet attrs) {
        TypedArray typedArray = context.obtainStyledAttributes(attrs, R.styleable.BGABadgeable);
    ...
    public void setmIsDirectionLeft(boolean mIsDirectionLeft) {
        this.mIsDirectionLeft = mIsDirectionLeft;
        mBadgeable.postInvalidate();
    }
    ...
    private void drawTextBadge(Canvas canvas) {
        ...
        if (mIsDirectionLeft) {
            ...
            mBadgeRectF.left = mBadgeable.getWidth() - mBadgeHorizontalMargin - badgeWidth;
        }
